...
-- ----------------------------
INSERT INTO `address_book` VALUES (1, 1, '', '', '', '', '', '', '', '', '', '', '', 1);
...
-- Records of category
-- ----------------------------
INSERT INTO `category` VALUES (1, NULL, '', 1, NULL, '2024-05-31 08:07:58', '2024-05-31 08:08:06', NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 70 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '菜品' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of dish
-- ----------------------------
INSERT INTO `dish` VALUES (1, '', 1, NULL, '', '', NULL, '2024-05-31 08:08:46', '2024-05-31 08:08:49', NULL, NULL);
...
CREATE TABLE `dish_flavor`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 104 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '菜品口味关系表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of dish_flavor
-- ----------------------------
INSERT INTO `dish_flavor` VALUES (1, 1, '', '');
...
-- Records of employee
-- ----------------------------
INSERT INTO `employee` VALUES (1, '', '', '', '', '', '', 1, '2024-05-31 08:00:00', '2024-05-31 08:00:00', NULL, NULL);
...
CREATE TABLE `order_detail`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '订单明细表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `shopping_cart`  (
  ...
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '购物车' ROW_FORMAT = Dynamic;
